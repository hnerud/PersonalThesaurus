...
namespace PersonalThesaurus.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,fileName,imagePath,size")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,fileName,imagePath,size")] Image image)
        {
            if (id != image.ID)
            {
                return NotFound();
